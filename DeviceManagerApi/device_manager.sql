...
CREATE TABLE `borrow`  (
  ...
  INDEX `fk_borrow_book_info_1`(`deviceId` ASC) USING BTREE,
  CONSTRAINT `borrow_ibfk_1` FOREIGN KEY (`deviceId`) REFERENCES `device_info` (`deviceId`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
-- Records of borrow
-- ----------------------------
INSERT INTO `borrow` VALUES (44, 14, 1, '2025-07-08 11:26:11', '2025-07-08 11:26:17');
INSERT INTO `borrow` VALUES (45, 14, 2, '2025-07-08 11:26:24', '2025-07-08 11:26:33');
INSERT INTO `borrow` VALUES (46, 14, 1, '2025-07-08 11:26:27', '2025-07-08 11:26:58');
INSERT INTO `borrow` VALUES (47, 1, 2, '2025-07-08 11:26:53', '2025-07-08 11:26:59');
INSERT INTO `borrow` VALUES (48, 15, 1, '2025-07-09 20:12:48', '2025-07-09 20:12:52');
INSERT INTO `borrow` VALUES (49, 14, 1, '2025-07-10 10:11:32', '2025-07-10 10:11:38');
INSERT INTO `borrow` VALUES (50, 14, 4, '2025-07-10 11:02:51', '2025-07-10 11:02:57');
...
CREATE TABLE `comment`  (
  ...
  `commentText` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `commentImg` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`commentId`) USING BTREE,
  INDEX `borrowIdWai`(`borrowId` ASC) USING BTREE,
  CONSTRAINT `borrowIdWai` FOREIGN KEY (`borrowId`) REFERENCES `borrow` (`borrowId`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of comment
-- ----------------------------
INSERT INTO `comment` VALUES (6, 45, 'niknsnivfr', NULL);
INSERT INTO `comment` VALUES (7, 50, '好用的一笔', NULL);
...
CREATE TABLE `device_info`  (
  ...
  `deviceImg` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '涔︾睄鍥剧墖',
  PRIMARY KEY (`deviceId`) USING BTREE,
  INDEX `fk_device_info_book_type_1`(`deviceTypeId` ASC) USING BTREE,
...
-- ----------------------------
INSERT INTO `device_info` VALUES (1, '佳能 EOS 5D Mark IV', '佳能', 14999.00, 1, '全画幅单反，高像素高感表现佳，对焦迅速，适合专业摄影及风光、人像拍摄，性能均衡。', 0, '/pic/0001.png');
...
INSERT INTO `user` VALUES (15, '学委', '123456', 0);
